    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('factor', models.DecimalField(default=1.0, help_text='Specifies the difference of the currency to default one.', verbose_name='factor', max_digits=10, decimal_places=4)),
